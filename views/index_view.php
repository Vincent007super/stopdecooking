        ...
        <div class="col-md-3 filter-container">
            <div class="filters mb-4 p-3 bg-white shadow rounded">
                ...
                <form method="GET" action="">
                    <div class="mb-2">
                        <input type="checkbox" name="category[]" id="category_all" value="all" class="form-check-input" <?= in_array('all', (array)($selectedCategories)) ? 'checked' : '' ?>>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 border-0 shadow rounded-3">
                                ...
                                <div class="card-footer bg-transparent border-top-0">
                                    <a href="recept.php?id=<?= htmlspecialchars($recept['ReceptID']) ?>" class="btn btn-success w-100">Bekijk Recept</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
